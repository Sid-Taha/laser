...
const images = ["/lm1.jpeg", "/lm2.webp", "/lm5.jpg", "/lmm.webp"];
const images2 = ["/m2.jpg", "/m5.jpg", "/m7.jpg", "/m10.jpg"];
...
const ImageSliderCard = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100 dark:bg-gray-900 gap-8 flex-wrap">
      {/* First Slider */}
